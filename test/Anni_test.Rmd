...
```{r}
fig2_type_key <- "TOTAL" 
fig2_exp_keys <- c("Exports")
fig2_dates <- c(2017, 2022)
fig2_country_keys <- c("EU27_2020", "AT", "BE", "BG", "CY", "CZ", "DE", "DK", "EE", "ES", "FI", "FR", "EL", "HR", "HU", "IE", "IT", "LT", "LU", "LV", "MT", "NL", "PL", "PT", "RO", "SE", "SI", "SK", "CH", "NO", "IS", "XK", "ME", "MK", "TR", "RS", "AL")
```

# Retrieve filtered data
```{r}
fig2_data <- get_eurostat_data(id,
                                 filters=
                                   list(geo = fig2_country_keys,
                                        sitc06 = fig2_type_key,
                                        indic_et = fig2_exp_keys),
                                 date_filter = fig2_dates,
                                 label = T
                                )
View(fig2_data)
```
